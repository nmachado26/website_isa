...
import Hero from "./images/proj1hero.png"; 
...
class Index extends React.Component {
  render() {
    return ( // TODO: change class name below
      <div className="proj1">
        <SEO title="Proj1" description="This is the description of project 2."/>
        <div className="hero__wrapper">
          <Header/>
          <InnerHero img={Hero}/>
          <InnerTxt heroCategory={Constants.proj1.heroCategory}
                    heroYear={Constants.proj1.heroYear}
                    heroDeliverable={Constants.proj1.heroDeliverable}
                    heroTitle={Constants.proj1.heroTitle}
        ...
        <Abstract
                  ...
                  abstractBody="Proj1 abstract body."
