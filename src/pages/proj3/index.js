...
import Hero from "./images/proj3hero.png"; 
...
class Index extends React.Component {
  render() {
    return ( // TODO: change class name below
      <div className="proj3">
        <SEO title="Proj3" description="This is the description of project 3."/>
        <div className="hero__wrapper">
          <Header/>
          <InnerHero img={Hero}/>
          <InnerTxt heroCategory={Constants.proj3.heroCategory}
                    heroYear={Constants.proj3.heroYear}
                    heroDeliverable={Constants.proj3.heroDeliverable}
                    heroTitle={Constants.proj3.heroTitle}
                    heroSummary="This is the summary of project 3. "
                    />
        </div>     
        <Abstract
                  ...
                  abstractBody="Proj3 abstract body."
                  liveLink="https://cluse.cc"
                  gitLink="https://github.com/ygev/cluse"/> 
        <div id="p1">
          
          <Phase phaseTitle="Project 3 Inspiration and Description"/>
