...
class Index extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <SEO title="Isabella M." description="Product designer by day, front-end engineer by night, when no one's watching. Love nothing more than hacking on sandbox products and software that facilitates human creativity."/>
        <main className="home">
